...
const obj_ComponentMap = new Map([['component', component],['form_button', form_button],['form_button_rich', form_button_rich],['form_button_span', form_button_span],['form_button_icon', form_button_icon],['form_button_anchor', form_button_anchor],['block', block],['form_field', form_field],['form_form', form_form],['form_hardrule', form_hardrule],['form_label', form_label],['form_menu_button_anchor', form_menu_button_anchor],['form_menu_button_icon', form_menu_button_icon],['form_menu_button_span', form_menu_button_span],['form_section', form_section],['form_span', form_span],['menu_button', menu_button],['xapp_accordion', xapp_accordion],['xapp_button', xapp_button],['xapp_theme', xapp_theme]]);
...
//START Project.js
class Project extends xapp_theme{
    constructor(obj_ini) {
        super(obj_ini); // call the super class constructor
...
obj_boot.obj_design.int_idRecord=75904; 
