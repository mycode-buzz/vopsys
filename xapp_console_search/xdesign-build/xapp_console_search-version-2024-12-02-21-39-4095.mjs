...
const obj_ComponentMap = new Map([['component', component],['form_inputandbutton', form_inputandbutton],['form_button', form_button],['form_button_rich', form_button_rich],['form_inputandbutton_submit', form_inputandbutton_submit],['form_button_anchor', form_button_anchor],['form_button_icon', form_button_icon],['form_button_search', form_button_search],['form_button_span', form_button_span],['form_input', form_input],['xapp_console_search', xapp_console_search]]);
...
//START Project.js
class Project extends xapp_console_search{
    constructor(obj_ini) {
        super(obj_ini); // call the super class constructor
...
obj_boot.obj_design.int_idRecord=76627; 
