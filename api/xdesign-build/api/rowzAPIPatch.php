...
class rowzAPIPatch extends rowzAPIHistory{       
    ...
    function fn_patchData(){        
        ...
        $obj_paramHistory->MetaViewId=$obj_paramView->MetaViewId;        
        $obj_paramHistory->MetaKeyName=$obj_paramView->MetaTableKeyField;
        $obj_paramHistory->MetaKeyValue=$obj_call->row_matchid;
        ...
        $int_countNameField=count($arr_nameField);
        for($i_nameField=0;$i_nameField<$int_countNameField;$i_nameField++){        
            $str_nameField=$arr_nameField[$i_nameField];
            $str_labelField=$arr_labelField[$i_nameField];            
            
            $str_sql.=$str_nameField;
            $str_sql.="=:";           
            $str_sql.=$str_labelField;     
            $str_sql.=",";           
        }
