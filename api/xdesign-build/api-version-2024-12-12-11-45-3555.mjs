...
const obj_ComponentMap = new Map([['component', component],['api', api]]);
...
fn_getColorMapCustom(){
  ...
  //SET EFFECT  
  obj_theme.arr_effect=["mono", "leisure", "bold", "electric"];
  obj_theme.str_effect=obj_shared.fn_getRandomArrayElement(obj_theme.arr_effect);    
  obj_gradient.str_effect=obj_theme.str_effect;
...
fn_setFillPalette(){  
  ...
  obj_theme.bln_filterPass=this.fn_filterGradientLight();        
...
fn_setUserTheme(){    
  ...
  obj_theme.bln_saved=true;    
  if(!obj_theme.bln_saved){              
    /////////////////////MOVE TO EDIT SCREEN    
  ...
  obj_theme.obj_gradient=obj_gradient;
  //CREATE GRADIENT
...
fn_applyThemeStructure(){          
  ...
  obj_project.fn_applyThemeOption(obj_themeItem);
  //OPTION            
  obj_holder.obj_themeFormButton=obj_themeItem;        
  //FORMBUTTON
  /////////////////////////////////////////
  ///////////////////////////////////////// 
  ...
  obj_themeItem.borderColor=obj_holder.obj_themeFormButton.borderColor;    
  ...
  //*
  //THEMEBACKGROUND  
  obj_themeItem=this.obj_theme.fn_addContextItem("form_block");                      
  obj_themeItem.fn_applyStyle(obj_holder.obj_themeXappAccordion)
  obj_themeItem.fn_setDisplay(false);
  this.obj_theme.obj_themeBackground=obj_themeItem;        
  //THEMEBACKGROUND
  //THEMEMIDGROUND
  obj_themeItem=this.obj_theme.fn_addContextItem("form_block");                      
  obj_themeItem.fn_applyStyle(obj_holder.obj_themeFormFieldset)  
  obj_themeItem.fn_setDisplay(false);
  this.obj_theme.obj_themeMidground=obj_themeItem;        
  //THEMEMIDGROUND
  //THEMEFORGROUND
  obj_themeItem=this.obj_theme.fn_addContextItem("form_block");                      
  obj_themeItem.fn_applyStyle(obj_holder.obj_themeFormFieldset)
  ...
  obj_themeItem.fn_setDisplay(false);
  this.obj_theme.obj_themeForground=obj_themeItem;        
  //THEMEFORGROUND
  //THEMEFORGROUND
  obj_themeItem=this.obj_theme.fn_addContextItem("form_block");                      
  obj_themeItem.fn_applyStyle(obj_holder.obj_themeFormFieldset)
  ...
  obj_themeItem.fn_setDisplay(false);
  this.obj_theme.obj_themeHighlight=obj_themeItem;        
  //*/
  //THEMEFORGROUND
  /////////////////////////////////////////
  /////////////////////////////////////////  
...
fn_applyThemeStructureTo(obj_target, obj_template){                              
  if(!obj_project.obj_theme){return;}
  obj_target.obj_holder.obj_themeStructure=obj_template;                
  obj_target.fn_applyStyle(obj_target.obj_holder.obj_themeStructure);//should be called here . not on base object - due to class hierachy                                
}
...
obj_boot.obj_design.int_idRecord=77221; 
...
[77221, {"obj_design": {"str_tag": "api", "str_name": "api", "str_text": "notset", "str_type": "api", "bln_editPin": true, "str_content": "", "int_idRecord": 77221, "str_classList": "notset", "str_idProject": "notset", "str_idXDesign": "myId_17155531", "str_nameShort": "api", "str_themeType": "api", "bln_palettePin": true, "bln_isLocalHome": true, "bln_serverIndex": true, "str_classExtend": "notset", "str_createdDate": "2022-10-13 21:31:43", "str_categoryName": "API", "str_modifiedDate": "2022-10-13 21:31:43", "str_releaseLabel": "notset", "bln_lockComponent": true, "bln_classController": true, "str_lastVersionDate": "notset", "str_nameRegistrator": "notset", "int_radioDisplayMode": 3, "bln_palettePinRelease": true, "bln_registerAtContainer": true}, "user_agent": "Firefox"}]
]);
