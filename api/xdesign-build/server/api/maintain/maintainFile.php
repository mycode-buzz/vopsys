...
class maintainFile extends maintainDemo{
    ...
    function fn_doImportFile(){
        ...
        if($this->bln_localHost){
            $str_pathFile="D:/var/www/html/vm-xdesign/vopsys/api/xdesign-build/server/api/upload/FileImport.csv";        
        }
        else{
    ...
    function fn_saveImportFile(){
        ...
        $str_pathFolder = dirname($_SERVER["DOCUMENT_ROOT"], 2)."/api/xdesign-build/server/api/upload/";
