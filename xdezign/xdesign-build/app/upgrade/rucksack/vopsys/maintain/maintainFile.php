...
class maintainFile extends maintainSetup{
    ...
    function fn_FILEGetData(){//array of json objects        
        ...
        //$this->fn_varDump($str_selectColumn, "str_selectColumn", true);
    ...
    function fn_FILEGetLink($obj_row){
        ...
        //$this->fn_varDump($obj_row, "fn_FILEGetLink", true);                            
        //return; 
        $arr_dataCSV=&$this->arr_dataCSV;
        $arr_jsonCSV=$this->arr_jsonCSV;
        $arr_headerMatch=$this->arr_headerMatch;        
        ...
        //$this->fn_varDump($obj_paramViewFrom->obj_paramViewFrom, "obj_paramViewFrom->MetaTableKeyField", true);                                    
        //$this->fn_varDump($obj_row, "obj_row", true);        
        $FromKeyValue=$obj_row->{$obj_paramViewFrom->MetaViewId.".".$obj_paramViewFrom->MetaTableKeyField};                    
        ...
        $arr_from=Array(                                   
            ...
            "$MetaLinkViewId.FromSchema"=>$obj_paramViewFrom->MetaSchemaName,
            "$MetaLinkViewId.FromTable"=>$obj_paramViewFrom->MetaTableName,
        ...
        for($i_view=0;$i_view<$i_count;$i_view++) {//FOR EACH VIEW        
            ...
            $arr_to=Array(                           
                ...
                "$MetaLinkViewId.ToSchema"=>$obj_paramViewTo->MetaSchemaName,
                "$MetaLinkViewId.ToTable"=>$obj_paramViewTo->MetaTableName,                
    ...
    function fn_callUpViewId($str_viewName){
        ...
        $str_sql="SELECT MetaViewId FROM meta_view WHERE MetaViewName=:MetaViewName;";
