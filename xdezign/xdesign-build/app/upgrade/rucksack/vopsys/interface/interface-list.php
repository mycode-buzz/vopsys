...
class interface_list extends datamanager{
    ...
    function fn_updateListLink($obj_callBack, $obj_column){

        /*
        $this->fn_varDumpPost();                
        $this->fn_varDump($obj_callBack, "obj_callBack", true);            
        $this->fn_varDump($obj_column, "obj_column", true);            
        $this->fn_varDump($obj_column->MetaList, "obj_column->MetaList", true);                
        $this->fn_varDump($this->obj_post->MetaListIdValue, "obj_post->MetaListIdValue", true);                
        //exit;
        //*/
        ...
        $arr_listExist=explode(",", $obj_callBack->response->history_fieldvalue);
        $arr_listExist = array_map('trim', $arr_listExist);
        $str_listExist = "'" . implode("','", $arr_listExist) . "'";
        //$this->fn_varDump($str_listExist, "str_listExist");
        //exit;        
        //*/
        $str_listExist=false;
