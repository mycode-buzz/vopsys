...
class rowzAPI extends rowzAPIWhere{    
    ...
    function fn_buildEndPoint($obj_param){
        ...
        if(empty($obj_param->api_domain)){
            ...
            $this->response->status_message="[buildEndpoint domain is not valid json]";                                    
            return;
        }        
        //*/
    ...
    function fn_writeResponse(){        
        ...
        if(!empty($get_archive))$obj_param->request->get_count=$get_archive;
    ...
    function fn_initOptions(){        
        ...
        if(!empty($cancel_get)){        
            ...
            if(!is_bool($cancel_get)){
                $this->response->status_code=400;
                $this->response->status_message="[cancel_get is not valid boolean]";                        
                return;         
            };        
        }
        //CANCEL GET
        ...
        if(!empty($get_user)){        
            ...
            if(!is_bool($get_user)){
                $this->response->status_code=400;
                $this->response->status_message="[get_user is not valid boolean]";                        
                return;         
            };        
        }
        //GET USER
        ...
        if(!empty($get_fqsn)){        
            ...
            if(!is_bool($get_fqsn)){
                $this->response->status_code=400;
                $this->response->status_message="[get_fqsn is not valid boolean]";                        
                return;         
            };        
        ...
        if(!empty($get_count)){        
            ...
            if(!is_bool($get_count)){
                $this->response->status_code=400;
                $this->response->status_message="[get_count is not valid boolean]";                        
                return;         
            };        
        ...
        if(!empty($get_archive)){        
            ...
            if(!is_bool($get_archive)){
                $this->response->status_code=400;
                $this->response->status_message="[get_archive is not valid boolean]";                        
                return;         
            };        
        ...
        //GET COUNT
         ...
         if(!empty($api_debug)){        
             ...
             if(!is_bool($api_debug)){
                 $this->response->status_code=400;
                 $this->response->status_message="[api_debug is not valid boolean]";                        
                 return;         
             };        
        ...
        if(!empty($get_autojoin)){        
            ...
            if(!is_bool($get_autojoin)){
                $this->response->status_code=400;
                $this->response->status_message="[get_autojoin is not valid boolean]";                        
                return;         
            };
        }        
        //GET AUTOJOIN
    ...
    function fn_initBaseView(){     
        ...
        if (!is_numeric($view_id) || empty($view_id)) {                        
            $this->response->status_code=400;
            $this->response->status_message="[view_id]";                        
            return;
        }                         
    ...
    function fn_initSelectColumn(){
        ...
        if(!empty($select_column)){        
            ...
            if(!$this->fn_validateJSONDecode(json_decode($select_column))){
                $this->response->status_code=400;
                $this->response->status_message="[select_column is not valid json]";                        
                return;         
            };        
        }
        //GET SELECT LIST        
    ...
    function fn_initRowMatch(){
        ...
        if(!empty($row_match)){        
            ...
            if(!$this->fn_validateJSONDecode(json_decode($row_match))){
                $this->response->status_code=400;
                $this->response->status_message="[row_match is not valid json]: ".$row_match;                        
                return;         
            };        
        }
        //GET ORDER LIST
        ...
        if(!empty($row_matchid)){        
            ...
            if(!is_numeric($row_matchid)){
                $this->response->status_code=400;
                $this->response->status_message="[row_match id is not valid number]";                        
                return;
            }                    
    ...
    function fn_initOrderColumn(){
        ...
        if(!empty($order)){        
            ...
            if(!$this->fn_validateJSONDecode(json_decode($order))){
                $this->response->status_code=400;
                $this->response->status_message="[order is not valid json]";                        
                return;         
            };        
        }
        //GET ORDER LIST
    ...
    function fn_initOffset(){       
        ...
        if (!is_numeric($limit)) {            
            $this->response->status_code=400;
            $this->response->status_message="[limit]";            
            return;
        } 
    ...
    function fn_setSelectColumn(){        
        ...
        if(empty($obj_metaView->arr_selectColumn)){
            $this->response->status_code=500;
            $this->response->status_message="[order view_data arr_selectColumn is empty]";                            
            return;
        }       
...
//*/
        ...
        try{                         
            ...
            $this->response->status_message="[row_match ".$e.getMessage()."]";                        
            return;
        }        
        ...
        if($bln_error){
            $this->response->status_code=400;
            $this->response->status_message="[row_match]";
    ...
    function fn_setOrderSQL(){        
        ...
        try{                         
            ...
            $this->response->status_code=050;
            $this->response->status_message="[order ".$e.getMessage()."]";                        
            return;
        }        
