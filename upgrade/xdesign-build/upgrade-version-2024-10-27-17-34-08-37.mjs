...
class PermitManager {  
    ...
    fn_compare(obj_metaSource, obj_metaCompare,  str_message="", bln_debugPermit=false){        
        ...
        if(!obj_metaSource){            
            console.log("error source is blank");
            return this.obj_permit100;            
        }

        if(!obj_metaCompare){            
            console.log("error compare is blank");
            return this.obj_permit100;            
        }
...
fn_maintainList(obj_list){
 ...
 fn_sleep(ms) {
  ...
  fn_parseDateTimeString(dateTimeString, bln_addTime=false) {
    if(!dateTimeString){
      //console.log("fn_parseDateTimeString: trapped empty string")
      return "";
    }
    if(dateTimeString===undefined){
      //console.log("fn_parseDateTimeString: trapped value of undefined")
      return "";
    }
    if(dateTimeString==="undefined"){
      //console.log("fn_parseDateTimeString: trapped string undefined")
      return "";
    }
...
class BaseObject extends LevelObject{
    ...
    fn_initialize(obj_ini){                           
        ...
        if(this.obj_design.str_nameShort==undefined){this.obj_design.str_nameShort="notset";}//ensure visible placeholder at front of object defintion
    ...
    fn_applyTheme(str_themeType=false, str_nameStyleProperty=false){   
    ...
    if(!obj_themeItem && str_themeType!=="notset"){ 
        ...
        if(obj_themeItem){                
            ...
            if(str_nameStyleProperty){
                let str_valueStyleProperty=obj_themeItem.fn_getStyleProperty(str_nameStyleProperty);
                if(!str_valueStyleProperty){
                    return;
                }
                return str_valueStyleProperty;
            }
        }
    }        
  ...
  fn_getThemeViaThemeType(str_themeType, bln_debug){          
    ...
    if(this.obj_design.str_themeType===str_themeType){               
        if(bln_debug){
  ...
  fn_setFocus(){
    ...
    fn_setDomProperty(str_name, foo_value){                          
        ...
        switch(str_name.toLowerCase()){
          case "disabled":
            this.fn_beforeDomPropertyDisabled(foo_value);
            //DOM
            if(this.dom_obj){   
                bln_value=foo_value;              
                if(bln_value){
            ...
            //DOM                        
            this.fn_afterDomPropertyDisabled(foo_value);
            break;
          default:            
...
class form_fieldset extends component{
  ...
  fn_onLoad(){
    ...
    let str_themeType, str_nameProperty;
    
    str_themeType="form_section";
    str_nameProperty="border";
    this.str_border=this.fn_applyTheme(str_themeType, str_nameProperty);
    
    str_themeType="form_section";
    str_nameProperty="boxShadow";
    this.str_boxShadow=this.fn_applyTheme(str_themeType, str_nameProperty);
    
    str_themeType="form_section";    
    str_nameProperty="padding";
    this.str_padding=this.fn_applyTheme(str_themeType, str_nameProperty);    
  }
  ...
  fn_open(){    
    ...
    this.fn_setStyleProperty("border", this.str_border);    
    this.fn_setStyleProperty("boxShadow", this.str_boxShadow);    
    this.fn_setStyleProperty("padding", this.str_padding);
...
/*type: xapp_menu_operation//*/
            ...
            //XSTART component/xapp_menu_operation
              class xapp_menu_operation extends xapp_component{
                ...
                fn_initialize(obj_ini){                
                  ...
                  //START INITIALIZE DESIGN        
                  if(this.fn_getIsOpen()===undefined){this.fn_setIsOpen(false);}//ensure visible placeholder at front of object defintion        
          ...
          fn_closeChildMenu(arr){
              ...
              fn_closePeersVertical(){                
                  //this.fn_debugText("fn_closePeersVertical");                
                  this.fn_closePeers();                
                  if(this.obj_parentMenu){this.obj_parentMenu.fn_closePeersVertical();}                                                
              }
              fn_closePeers(){                
                  //this.fn_debugText("fn_closePeers");                
...
/*type: xapp_menu//*/
        ...
        //*          
          ...
          fn_runCount(){
            ...
            if(this.fn_getSettingPin()){//dont apply to settings ui        
              //return;
            }
          ...
          fn_setButtonViewRecord(){                          
            ...
            if(this.bln_hasShowRowButton){          
              //this.obj_consoleContainerGeneral.fn_showItem(this.obj_button_row_hide);                                              
              //this.obj_consoleContainerGeneral.fn_showItem(this.obj_button_row_show);              
            }                      
          ...
          fn_classifyLevel(){
            ...
            //there may be circ s when a dynamic menu also contains multiple records,  e.g in a  group by having set of menus, in which case the code can be developed to allow additional records to be added.
            if(this.fn_getIsMenuWithView()){
              this.bln_isParentMenuWithView=true;                
            }
            //*/
          ...
          fn_formNavigateToggleArchive(){                                          
            ...
            obj_settingmenu.fn_settingPinDisplay();                             
            let obj_standardMenu=obj_settingmenu.obj_parentMenu;
            int_idMetaRowz=obj_standardMenu.fn_getMetaRowzId();
            //*/
          ...
          fn_settingPinDisplay(){    
            ...
            this.fn_toggle(); 
            //this.fn_debugText("this.fn_getIsOpen(): " + this.fn_getIsOpen());                       
            ...
            //this.fn_toggleHidden(true);

            
            /*
            let bln_hidden=this.fn_getHiddenPin();              
            let bln_isOpen=this.fn_getIsOpen();
            if(bln_hidden){
            
              this.fn_open(true);
              let obj_container;
              obj_container=this.obj_parentMenu.fn_getAccordionView();                              
              obj_container.fn_debug("fn_getAccordionView");
              obj_container=this.obj_parentMenu.fn_getAccordionChildMenu();                              
              obj_container.fn_debug("fn_getAccordionChildMenu");
              //this.obj_parentMenu.fn_displayAccordionChildMenu(true);                            
              this.obj_parentMenu.fn_displayAccordionView(false);              
              //this.obj_parentMenu.fn_hideStandardMenu();
              ...
              //this.obj_parentMenu.fn_showStandardMenu();
            }            
            //*/
            ...
            if(bln_hidden){
              ...
              this.fn_setHiddenPin(true);            
              if(!this.obj_parentMenu.obj_meta.bln_displayAccordionChildMenu){
                this.obj_parentMenu.fn_displayAccordionChildMenu(false);
              }
            } 
            //*/                                           
          ...
          fn_onDataEnd(){                          
            ...
            if(this.bln_hasShowRowButton){          
              if(this.obj_dataView){
                ...
                this.fn_showObjectButton(this.obj_button_row_show, this.obj_button_row_hide, "`meta_rowz`.`meta_rowz`.`HiddenPin`");              
              }
            }  
          }   
        ...
        //////////////////////////////////////
          ...
          fn_setMenuPanel(){     
            ...
            //obj_container.bln_debugContainer=true;

            //this.obj_button_navigate_login=obj_container.fn_getConsoleComponent("xapp_button_navigate_login");
            ...
            this.obj_button_row_hide=obj_container.fn_getConsoleComponent("xapp_button_general_row_hide");                          
            this.obj_button_row_show=obj_container.fn_getConsoleComponent("xapp_button_general_row_show");                          
        ...
        fn_configureDynamicMenuFromRow(obj_rowMenu){    
          ...
          if(obj_metaColumn){                              
            ...
            //alert(obj_metaColumnKey);
            this.obj_columnKey=obj_rowMenu.fn_getColumnViaPosition(obj_metaColumnKey.int_ordinalPosition);                                                                  
            if(this.obj_columnKey){//if not set will cause an issue with delete on dynamic menu
              this.obj_columnKey.fn_setMetaColumnKey(obj_metaColumnKey);
...
/*type: xapp_data//*/
            ...
            class xapp_data extends xapp_ajax{
              ...
              fn_initializeRS(obj_menuButton){                                  
                ...
                this.obj_paramRS.bln_axis=false;//row              s                           
            ...
            //XSTART component/xapp_dataform
              class xapp_dataform extends xapp_data{
                ...
                fn_formatColumnQuery(obj_column){
                  ...
                  obj_columnKey=obj_row.fn_getColumnViaPosition(obj_metaColumnKey.int_ordinalPosition);                  
                  if(!obj_columnKey){
                  ...
                  /*
                  console.log(this.obj_columnKeyX);
                  console.log(obj_columnKey);
                  alert("obj_columnKey : " + obj_columnKey.str_value);
                  if(this.obj_columnKeyX!==obj_columnKey){
                    alert("this.obj_columnKeyX !== obj_columnKey");
                  }
                  else{
                    alert("this.obj_columnKeyX === obj_columnKey");
                  }
...
/*type: xapp_button//*/
      ...
      class xapp_button extends form_button{
        constructor(obj_ini) {      
          super(obj_ini);        
        } 
        fn_initialize(obj_ini){
...
/*type: form_inputandbutton_submit//*/
            ...
            class form_inputandbutton_submit extends form_input{
              constructor(obj_ini) {      
                super(obj_ini);        
              } 
              fn_initialize(obj_ini){
...
/*type: form_showhide//*/
      ...
      class form_showhide extends form_button{
        constructor(obj_ini) {      
          super(obj_ini);        
        } 
        fn_initialize(obj_ini){
            ...
            //XSTART component/xapp_column
              class xapp_column extends component{
                ...
                fn_onLoad(){
                  ...
                  let str_themeType, str_nameProperty;
                  str_themeType="form_blockHighlight";
                  str_nameProperty="background";
                  this.str_colorHighlight=this.fn_applyTheme(str_themeType, str_nameProperty);

                  str_themeType="form_legend";
                  str_nameProperty="border";
                  this.str_borderLegend=this.fn_applyTheme(str_themeType, str_nameProperty);
                ...
                fn_initializeColumn(obj_row){                                                      
                  ...
                  if(obj_metaColumn.MetaOption){                
                    ...
                    /*
                    {"FormExpand": "false", "FormPosition": "default"}
                    //*/
                    if(obj_metaColumn.DebugPin){                      
                      //console.log(obj_metaOption);
                    }  
                    Object.assign(obj_metaColumn, obj_metaOption);//assign all options to meta object
                  }
                  ...
                  obj_metaColumn.DateTime=obj_shared.fn_parseBool(obj_metaColumn.DateTime);                                    
            ...
            //XSTART component/xapp_data_childmenu
              class xapp_data_childmenu extends xapp_data{
                ...
                fn_onDataEnd(){                  
                  let obj_parent=this.obj_paramRS.obj_menuButton;                                                
                  if(!obj_parent){return;}                                    
                  obj_parent.fn_onDataEndChildMenu();                                    
                }
                fn_onComputeRow(){                                   
            ...
            //XSTART component/xapp_data_view
              class xapp_data_view extends xapp_data{
                ...
                fn_onDataEnd(){
                  ...
                  let obj_menuButton=this.obj_paramRS.obj_menuButton;                                                
                  if(!obj_menuButton){return;}                                    
                  obj_menuButton.fn_onDataEndView();                                    
                }                
                //----------------------------------------
                //SIGNPOST 10. obj_dataView fn_runComputeRow
                //----------------------------------------
            ...
            class xapp_menuform extends xapp_menu{
              ...
              fn_setMenuPanel(){     
                ...
                if(this.obj_menuPanel){                  
                  ...
                  this.obj_button_delete_record=this.obj_consoleContainerRecord.fn_getComponent("xapp_button_delete_record");
                  ...
                  this.bln_button_recycle_record=false;
                  this.bln_button_complete_record=true;
                  if(this.bln_button_recycle_record){
                    this.obj_button_recycle_record=this.obj_consoleContainerRecord.fn_getComponent("xapp_button_recycle_record");                    
                  }
                  if(this.bln_button_complete_record){
              ...
              fn_recycleRecord(bln_recycle){      
                ...
                if(!this.obj_dataView){return;}    
                if(!this.obj_columnKey.str_value){return;}//only 1 record with columnkey can be deleted. 
                this.obj_dataView.fn_recycleRecord(this.obj_columnKey, bln_recycle); 
              }
              ...
              fn_setButtonViewRecord(){                
                ...
                if(this.bln_button_complete_record){
                  ...
                  this.fn_debugName("fn_setButtonViewRecord")
                }                
                ...
                if(this.bln_hasChildForm){                                    
                  ...
                  if(obj_project.fn_getAllowDelete()){                      
                    this.obj_consoleContainerRecord.fn_showItem(this.obj_button_delete_record);                                          
                  } 
                ...
                if(this.bln_isJoinedChildMenu){
                  this.obj_consoleContainerRecord.fn_hideItem(this.obj_button_delete_record);                    
                }
              }
              ...
              fn_formCompleteRecord(){               
                
                let obj_menuButton=this;
                if(this.bln_dynamicMenu){                             
                  if(!this.obj_columnKey.str_value){                    
                    obj_menuButton=this.obj_parentMenu;      
                  } 
                }
                //obj_menuButton.fn_debugText("1 fn_exitNewRecord");
                obj_menuButton.fn_exitNewRecord();                                                                      
                obj_menuButton.bln_flagRunOnce=false;
                ...
                if(obj_menuButton.obj_dataView){
                  obj_menuButton.obj_dataView.fn_resetDataView();//important to avoid page mis match                
                }                
              ...
              fn_setButtonEditRecord(){              
                ...
                if(this.obj_meta.bln_displayData){
                  ...
                  if(this.bln_button_complete_record){
                    this.fn_debugName("fn_setButtonEditRecord");
                    this.obj_consoleContainerRecord.fn_showItem(this.obj_button_complete_record);
                  }                                  
              ...
              fn_setButtonNewRecord(){                  
                ...
                if(this.obj_meta.bln_displayData){                  
                  ...
                  if(this.fn_setButtonNewRecord){
                    //this.fn_debugName("fn_setButtonNewRecord");
                    //this.obj_consoleContainerRecord.fn_showItem(this.obj_button_complete_record);                                
                  }                                                    
                  this.obj_consoleContainerRecord.fn_hideItem(this.obj_button_navigate_record);
                  
                }
                else if(this.fn_getIsMenuWithView()){                                    
                  this.obj_consoleContainerRecord.fn_hideItem(this.obj_button_new_record);
                }
...
[76450, {"obj_design":{"int_idRecord":76450,"str_idXDesign":"myId_86100065","str_name":"theme_dark","str_type":"xapp_theme","str_tag":"theme_dark","bln_isLocalHome":true,"bln_registerAtProject":true,"str_idProject":"myId_11188187","str_nameShort":"theme_dark","str_createdDate":"2022-0-22 15:19:43","str_modifiedDate":"2022-0-22 15:19:43","bln_createRelease":"false","bln_editPin":true,"str_categoryName":"Anchor","str_themeType":"theme","bln_palettePinRelease":true,"bln_registerAtContainer":true,"bln_palettePin":true,"arr_item":[{"obj_design":{"int_idRecord":"76964","str_type":"xapp_accordion"}},{"obj_design":{"int_idRecord":"76996","str_type":"form_hardrule"}}],"bln_isThemeItem":true,"bln_classController":"false"},"obj_domProperty":{"Id":"myId_86100065"},"obj_domStyle":{"font-family":"Helvetica, Arial, sans-serif","xapp_theme":"xapp_theme","display":"block"},"user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_86100065"}}],
...
[76691, {"obj_design":{"int_idRecord":76691,"str_idXDesign":"myId_26452456","str_name":"form_dashboard","str_nameShort":"form_dashboard","str_type":"component","str_tag":"form_dashboard","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_createRelease":"false","bln_isLocalHome":true,"str_themeType":"form_section","bln_editPin":true,"bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_isThemeItem":true,"bln_lockComponent":true,"str_categoryName":"Xtra","str_classExtend":"component","bln_classController":"false"},"obj_domStyle":{"flex-direction":"column","flex-wrap":"wrap","gap":"10px","display":"flex","flex-flow":"row wrap","10px":"red","border":"0px solid black","padding":"0px"}}],
[76718, {"obj_design":{"int_idRecord":76718,"str_idXDesign":"myId_99559514","str_name":"form_label","str_nameShort":"form_label","str_type":"form_label","str_themeType":"form_label","str_tag":"label","str_createdDate":"2022-11-13 21:59:51","str_modifiedDate":"2022-11-13 21:59:51","bln_editPin":true,"bln_typeable":true,"str_text":"My Label","bln_registerAtContainer":true,"bln_isThemeItem":true,"bln_palettePinRelease":true,"bln_palettePin":true,"str_idProject":"myId_86100065"},"obj_domProperty":{"innerText":"My Label"},"obj_domStyle":{"padding":"10px","word-break":"normal","min-width":"175px","max-width":"175px","max-height":"175px","overflow":"auto","color":"white"}}],
[76719, {"obj_design":{"str_tag":"text","str_type":"form_span","str_idXDesign":"myId_94495116","str_name":"form_span","str_nameShort":"form_span","str_themeType":"form_input","int_idRecord":76719,"str_createdDate":"2022-11-18 16:02:10","str_modifiedDate":"2022-11-18 16:02:10","blnIsTag":true,"bln_editPin":true,"bln_typeable":true,"bln_registerAtContainer":true,"bln_isThemeItem":true,"str_text":"-","bln_palettePinRelease":true,"bln_palettePin":true,"str_idProject":"myId_86100065","bln_classController":"false","str_categoryName":"Xtra"},"obj_domProperty":{"innerText":"form_input","innerHTML":"-"},"obj_domStyle":{"padding":"10px","word-break":"normal","maxheight":"175","overflow":"auto","max-width":"175px","border":"0px solid black","border-radius":"4px","background":"rgb(65, 65, 65)","color":"white","max-height":"500px"},"dom_objContentContainer":{"value":"-"}}],
[76720, {"obj_design":{"int_idRecord":76720,"str_idXDesign":"myId_18699699","str_name":"form_field","str_nameShort":"form_field","str_type":"form_field","str_tag":"field","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_createRelease":"false","bln_isLocalHome":true,"str_themeType":"form_field","bln_editPin":true,"bln_registerAtContainer":true,"arr_item":[{"obj_design":{"int_idRecord":76718,"str_type":"form_label"}},{"obj_design":{"int_idRecord":76719,"str_type":"form_span"}}],"bln_isThemeItem":true,"bln_palettePinRelease":true,"bln_palettePin":true,"str_idProject":"myId_86100065","bln_classController":"false","bln_lockComponent":true,"str_categoryName":"Xtra"},"obj_domStyle":{"display":"flex","flex-wrap":"wrap","flex-flow":"column wrap"}}],
...
[76722, {"obj_design":{"int_idRecord":76722,"str_idXDesign":"myId_11919981","str_name":"form_section","str_nameShort":"form_section","str_type":"form_section","str_tag":"fieldset","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_createRelease":"false","bln_isLocalHome":true,"str_themeType":"form_section","bln_editPin":true,"bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"arr_item":[{"obj_design":{"int_idRecord":77186,"str_type":"form_legend"}},{"obj_design":{"int_idRecord":76720,"str_type":"form_field"}},{"obj_design":{"int_idRecord":76721,"str_type":"form_button_submit"}}],"bln_isThemeItem":true,"str_idProject":"myId_86100065","str_categoryName":"Xtra","bln_classController":"false"},"obj_domProperty":{"Id":"myId_11919981"},"obj_domStyle":{"flex-direction":"column","flex-wrap":"wrap","gap":"10px","display":"flex","flex-flow":"row wrap","align-self":"flex-start","border":"1px outset rgb(65, 65, 65)","border-radius":"4px","padding":"10px"},"dom_objContentContainer":{"Id":"myId_11919981"}}],
[76725, {"obj_design":{"int_idRecord":76725,"str_idXDesign":"myId_55717686","str_name":"form_form","str_nameShort":"form_form","str_type":"form_form","str_tag":"form","bln_registerAtContainer":true,"str_classExtend":"component","str_createdDate":"2022-11-01 21:47:45","str_modifiedDate":"2022-11-01 21:47:45","bln_editPin":true,"str_themeType":"form_form","bln_isLocalHome":true,"bln_palettePinRelease":true,"bln_palettePin":true,"arr_item":[{"obj_design":{"int_idRecord":"76726","str_type":"component"}},{"obj_design":{"int_idRecord":76691,"str_type":"component"}}],"str_idProject":"myId_86100065","bln_isThemeItem":true,"bln_classController":"false","str_categoryName":"Xtra"},"obj_domProperty":{"Id":"myId_55717686"},"obj_domStyle":{"flex-wrap":"wrap","display":"flex"," background-color":"coral","flex-direction":"column","font-family":"Helvetica, Arial, sans-serif"},"dom_objContentContainer":{"0":{"Id":"myId_11919981"},"1":{"Id":"myId_58548814"},"Id":"myId_55717686"}}],
[76726, {"obj_design":{"int_idRecord":"76726","str_idXDesign":"myId_86155599","str_name":"form_menu_panel_dark","str_nameShort":"form_menu_panel_dark","str_type":"component","str_themeType":"form_menu_panel","str_tag":"form_menu_panel_dark","bln_registerAtContainer":true,"str_createdDate":"2022-11-15 08:47:57","str_modifiedDate":"2022-11-15 08:47:57","bln_editPin":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_isThemeItem":true,"arr_item":[{"obj_design":{"int_idRecord":76722,"str_type":"form_section"}}],"str_idProject":"myId_11177936","bln_classController":"false"},"obj_domProperty":{"Id":"myId_86155599"},"obj_domStyle":{"flexdirection":"column","gap":"10px","display":"flex","padding":"10px","flex-direction":"column","flex flow":"column wrap","border":"0px solid white"},"dom_objContentContainer":{"Id":"myId_86155599"}}],
...
[76963, {"obj_design":{"int_idRecord":"76963","str_idXDesign":"myId_06009333","str_name":"menu_button","str_nameShort":"menu_button","str_type":"menu_button","str_tag":"button","str_createdDate":"2022-02-02 20:04:57","str_modifiedDate":"2022-02-02 20:04:57","str_text":"My Menubutton","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"menu_button","bln_registerAtContainer":true,"str_idProject":"myId_71626268","bln_isThemeItem":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false","bln_isOpen":true,"arr_item":[{"obj_design":{"int_idRecord":"77416","str_type":"form_menu_button_anchor"}}]},"obj_domProperty":{"innerText":"My Menubutton","innerHTML":"My Menubutton","xDesign_MenuButtonClick":"fn_MenuButtonClick","Id":"myId_06009333"},"obj_domStyle":{"cursor":"pointer","font-size":"100%","padding-bottom":"2px","padding":"15px 15px","color":"white","0px solid rgb(41, 108, 151)":"0px solid black","border-bottom":"1px solid rgb(41, 108, 151)","border-width":"0px 0px 1px","background":"rgb(65, 65, 65)","width":"100%","border":"1px outset rgb(65, 65, 65)","justify-content":"center","align-items":"center","border-radius":"0px","display":"block"}}],
[76964, {"obj_design":{"int_idRecord":"76964","str_idXDesign":"myId_33319396","str_name":"xapp_accordion","str_nameShort":"xapp_accordion","str_type":"xapp_accordion","str_tag":"accordion","bln_registerAtContainer":true,"str_createdDate":"2022-11-01 21:51:10","str_modifiedDate":"2022-11-01 21:51:10","bln_editPin":true,"str_themeType":"xapp_accordion","bln_isLocalHome":true,"arr_item":[{"obj_design":{"int_idRecord":"76963","str_type":"menu_button"}},{"obj_design":{"int_idRecord":76725,"str_type":"form_form"}}],"bln_registerAtProject":true,"str_idProject":"myId_15156259","bln_isThemeItem":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false"},"obj_domProperty":{"Id":"myId_33319396"},"obj_domStyle":{"width":"100%","display":"block","":"green","background":"gray"},"dom_objContentContainer":{"Id":"myId_33319396"}}],
[76996, {"obj_design":{"int_idRecord":"76996","str_idXDesign":"myId_61115655","str_name":"form_hardrule","str_nameShort":"form_hardrule","str_type":"form_hardrule","str_themeType":"form_hardrule","str_tag":"hr","bln_registerAtContainer":true,"str_createdDate":"2023-09-28 17:30:59","str_modifiedDate":"2023-09-28 17:30:59","bln_editPin":true,"bln_palettePinRelease":true,"bln_palettePin":true,"str_idProject":"myId_86100065","bln_isThemeItem":true,"bln_classController":"false"},"obj_domStyle":{"height":"10px","width":"100%","border":"0px","background":"rgb(65, 65, 65)"}}],
[77012, {"obj_design":{"int_idRecord":77012,"str_idXDesign":"myId_09399160","str_name":"form_form","str_nameShort":"form_form","str_type":"form_form","str_tag":"form","bln_registerAtContainer":true,"str_classExtend":"component","str_createdDate":"2022-11-01 21:47:45","str_modifiedDate":"2022-11-01 21:47:45","bln_editPin":true,"str_themeType":"form_form","bln_isLocalHome":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false","str_categoryName":"Xtra"},"obj_domStyle":{"flex-wrap":"wrap","display":"flex"," background-color":"coral","flex-direction":"column","gap":"10px"},"user_agent":"Firefox"}],
...
[77024, {"obj_design":{"int_idRecord":77024,"str_idXDesign":"myId_13000276","str_name":"form_field","str_nameShort":"form_field","str_type":"form_field","str_tag":"field","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_createRelease":"false","bln_isLocalHome":true,"str_themeType":"form_field","bln_editPin":true,"bln_registerAtContainer":true,"arr_item":[{"obj_design":{"int_idRecord":77022,"str_type":"form_label"}},{"obj_design":{"int_idRecord":77023,"str_type":"form_text"}}],"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false","str_categoryName":"Other"},"obj_domProperty":{"Id":"myId_13000276"},"obj_domStyle":{"display":"flex","flex-wrap":"wrap","flex-flow":"wrap"," justify-content":"center","align-items":"center","justify-content":"center"},"user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_13000276"}}],
[77025, {"obj_design":{"int_idRecord":77025,"str_idXDesign":"myId_77699970","str_name":"form_textarea","str_nameShort":"form_textarea","str_type":"form_input","str_tag":"textarea","str_createdDate":"2022-02-02 19:57:30","str_modifiedDate":"2022-02-02 19:57:30","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_input","bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false","str_categoryName":"Xtra"},"obj_domStyle":{"padding":"10px","cursor":"pointer","border":"0px none"}}],
...
[77027, {"obj_design":{"int_idRecord":"77027","str_idXDesign":"myId_49913170","str_name":"form_select","str_nameShort":"form_select","str_type":"form_select","str_tag":"select","str_createdDate":"2022-02-02 19:57:30","str_modifiedDate":"2022-02-02 19:57:30","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_select","bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false"},"obj_domStyle":{"cursor":"pointer","padding":"10px","border":"0px","color":"black"}}],
...
[77038, {"obj_design":{"int_idRecord":77038,"str_idXDesign":"myId_76211896","str_name":"xapp_button_navigate_office","str_nameShort":"xapp_button_navigate_office","str_type":"xapp_button_navigate_office","str_tag":"button","str_content":"My component","str_createdDate":"2022-02-02 19:54:40","str_modifiedDate":"2022-02-02 19:54:40","bln_typeable":true,"bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_button","bln_registerAtContainer":true,"str_classExtend":"xapp_console_button","blnIsTag":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":true,"bln_lockComponent":true,"str_categoryName":"Other","str_idProject":"myId_36985869","arr_item":[{"obj_design":{"int_idRecord":77393,"str_type":"form_button_anchor"}}],"str_icon":"fa-solid fa-mug-hot"},"obj_domProperty":{"innerText":"Desktop","innerHTML":"Office","str_name":"xapp_button_navigate_desktop","arial-label":"Goto Office","Id":"myId_76211896"},"obj_domStyle":{"padding":"10px","cursor":"pointer"},"bln_enabled":true,"user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_76211896","str_name":"xapp_button_navigate_desktop","arial-label":"Goto Office"},"obj_anchor":{"obj_design":{"int_idRecord":77393,"str_type":"form_button_anchor"}}}],
...
[77084, {"obj_design":{"int_idRecord":77084,"str_idXDesign":"myId_61351551","str_name":"form_checkbox","str_nameShort":"form_checkbox","str_type":"form_checkbox","str_tag":"input","str_createdDate":"2022-02-02 19:57:30","str_modifiedDate":"2022-02-02 19:57:30","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_checkbox","bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false","str_categoryName":"Xtra","str_text":"on"},"obj_domProperty":{"type":"checkbox","checked":true},"obj_domStyle":{"cursor":"pointer","border":"0px none","content":"\\2713","height":"40px","width":"40px","vertical-align":"middle","margin":"0px"}}],
[77152, {"obj_design":{"int_idRecord":77152,"str_idXDesign":"myId_11190110","str_name":"xapp_button","str_nameShort":"xapp_button","str_type":"xapp_button","str_themeType":"form_button","str_tag":"button","bln_registerAtContainer":true,"str_createdDate":"2022-11-20 23:26:20","str_modifiedDate":"2022-11-20 23:26:20","bln_editPin":true,"str_text":"xapp_button","bln_classController":true,"bln_palettePinRelease":true,"bln_palettePin":true,"str_classExtend":"form_button","bln_lockComponent":true,"str_categoryName":"Xapp","str_icon":"fa-solid fa-home","arr_item":[{"obj_design":{"int_idRecord":77388,"str_type":"form_anchor"}}],"str_idProject":"myId_36985869"},"obj_domProperty":{"innerText":"My Button","innerHTML":"xapp_button","Id":"myId_11190110"},"obj_domStyle":{"aliign-items":"center","padding":"10px"},"bln_enabled":true,"user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_11190110"}}],
...
[77186, {"obj_design":{"int_idRecord":77186,"str_idXDesign":"myId_17200121","str_name":"form_legend","str_nameShort":"form_legend","str_type":"form_legend","str_tag":"legend","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_palettePinRelease":true,"bln_palettePin":true,"bln_createRelease":"false","bln_isLocalHome":true,"str_themeType":"form_legend","bln_editPin":true,"bln_registerAtContainer":true,"str_idProject":"myId_11919981","bln_classController":"false","str_categoryName":"Xtra"},"obj_domProperty":{"href":"https://www.mycode.buzz","target":"_blank"},"obj_domStyle":{"display":"block","text-decoration":"none","color":"white","border-radius":"4px","padding":"7px","border":"1px outset rgb(65, 65, 65)"},"dom_objContentContainer":{"href":"https://www.mycode.buzz","target":"_blank"}}],
[77187, {"obj_design":{"int_idRecord":"77187","str_idXDesign":"myId_82227821","str_name":"form_legend","str_nameShort":"form_legend","str_type":"form_legend","str_tag":"legend","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_palettePinRelease":true,"bln_palettePin":true,"bln_createRelease":"false","bln_isLocalHome":true,"str_themeType":"form_legend","bln_editPin":true,"bln_registerAtContainer":true,"bln_classController":"false","str_classExtend":"form_button"},"obj_domProperty":{"href":"https://www.mycode.buzz","target":"_blank","tabIndex":"0"},"obj_domStyle":{"display":"block","text-decoration":"none","color":"white","user-select":"none"},"bln_enabled":true,"dom_objContentContainer":{"href":"https://www.mycode.buzz","target":"_blank"}}],
[77192, {"obj_design":{"int_idRecord":77192,"str_idXDesign":"myId_13355182","str_name":"form_tabset","str_nameShort":"form_tabset","str_type":"form_tabset","str_tag":"tabset","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":true,"bln_lockComponent":true,"str_categoryName":"Xtra","arr_item":[{"obj_design":{"int_idRecord":77193,"str_type":"form_panellist"}},{"obj_design":{"int_idRecord":77194,"str_type":"form_tablist"}}],"str_themeType":"form_tabset"},"obj_domProperty":{"role":"tablist","aria-label":"Tab Set","Id":"myId_13355182"},"obj_domStyle":{"flex-direction":"column","flex-wrap":"wrap","gap":"10px","display":"none"},"dom_objContentContainer":{"Id":"myId_13355182","aria-label":"Tab Set"},"obj_panellist":{"obj_design":{"int_idRecord":77193,"str_type":"form_panellist"}},"obj_tablist":{"obj_design":{"int_idRecord":77194,"str_type":"form_tablist"}}}],
...
[77216, {"obj_design":{"int_idRecord":77216,"str_idXDesign":"myId_89779155","str_name":"xapp_button_navigate_newrow","str_nameShort":"xapp_button_navigate_newrow","str_type":"xapp_button_navigate_newrow","str_tag":"button","str_content":"My component","str_createdDate":"2022-02-02 19:54:40","str_modifiedDate":"2022-02-02 19:54:40","bln_typeable":true,"str_text":"Add New Row","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_button","bln_registerAtContainer":true,"str_classExtend":"xapp_console_button","blnIsTag":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":true,"bln_lockComponent":true,"str_categoryName":"Xtra","str_idProject":"myId_36985869"},"obj_domProperty":{"innerText":"Desktop","str_name":"xapp_button_navigate_desktop","innerHTML":"Add New Row"},"obj_domStyle":{"padding":"10px","cursor":"pointer"},"bln_enabled":true,"dom_objContentContainer":{"str_name":"xapp_button_navigate_desktop"}}],
[77217, {"obj_design":{"int_idRecord":77217,"str_idXDesign":"myId_14185411","str_name":"xapp_button_general_row_hide","str_nameShort":"xapp_button_general_row_hide","str_type":"xapp_button_general_row_hide","str_tag":"button","str_content":"My component","str_createdDate":"2022-02-02 19:54:40","str_modifiedDate":"2022-02-02 19:54:40","bln_typeable":true,"str_text":"Hide","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_button","bln_registerAtContainer":true,"str_classExtend":"xapp_console_button","blnIsTag":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":true,"bln_lockComponent":true,"str_categoryName":"Xtra"},"obj_domProperty":{"innerText":"Desktop","str_name":"xapp_button_navigate_desktop","innerHTML":"Hide"},"obj_domStyle":{"padding":"10px","cursor":"pointer"},"bln_enabled":true,"dom_objContentContainer":{"str_name":"xapp_button_navigate_desktop"}}],
[77222, {"obj_design":{"int_idRecord":77222,"str_idXDesign":"myId_40446418","str_name":"upgrade","str_nameShort":"upgrade","str_type":"upgrade","str_tag":"upgrade","bln_classController":true,"str_createdDate":"2022-10-13 21:31:43","str_modifiedDate":"2022-10-13 21:31:43","bln_isLocalHome":true,"str_categoryName":"Upgrade","str_classExtend":"xapp","bln_editPin":true,"str_themeType":"upgrade","bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_lockComponent":true,"arr_item":[{"obj_design":{"int_idRecord":76450,"str_type":"xapp_theme"}},{"obj_design":{"int_idRecord":6009,"str_type":"authorise_gate"}},{"obj_design":{"int_idRecord":"76960","str_type":"xapp_dynamic_content"}},{"obj_design":{"int_idRecord":"76961","str_type":"xapp_context_holder"}}],"int_radioDisplayMode":3,"str_nameRegistrator":"notset","str_idProject":"notset","str_content":"","str_classList":"notset","str_releaseLabel":"notset","str_text":"notset","str_lastVersionDate":"notset"},"obj_domProperty":{"Id":"myId_40446418"},"bln_togglePeersPin":true,"bln_closePeersPin":true,"MetaDataViewId":101426,"MetaDataViewName":"meta_data","MetaUserViewId":1,"MetaUserViewName":"meta_user","MetaLinkViewId":100475,"MetaLinkViewName":"meta_link","user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_40446418"},"obj_theme":{"obj_design":{"int_idRecord":76450,"str_type":"xapp_theme"}}}],
[77309, {"obj_design":{"int_idRecord":77309,"str_idXDesign":"myId_45945215","str_name":"xapp_button_general_row_show","str_nameShort":"xapp_button_general_row_show","str_type":"xapp_button_general_row_show","str_tag":"button","str_content":"My component","str_createdDate":"2022-02-02 19:54:40","str_modifiedDate":"2022-02-02 19:54:40","bln_typeable":true,"str_text":"Show","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_button","bln_registerAtContainer":true,"str_classExtend":"xapp_console_button","blnIsTag":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":true,"bln_lockComponent":true,"str_categoryName":"Xtra","str_idProject":"myId_36985869"},"obj_domProperty":{"innerText":"Desktop","str_name":"xapp_button_navigate_desktop","innerHTML":"Show"},"obj_domStyle":{"padding":"10px","cursor":"pointer"},"bln_enabled":true,"dom_objContentContainer":{"str_name":"xapp_button_navigate_desktop"}}],
[77310, {"obj_design":{"int_idRecord":77310,"str_idXDesign":"myId_94777779","str_name":"xapp_button_navigate_toggle_archive","str_nameShort":"xapp_button_navigate_toggle_archive","str_type":"xapp_button_navigate_toggle_archive","str_tag":"button","str_content":"My component","str_createdDate":"2022-02-02 19:54:40","str_modifiedDate":"2022-02-02 19:54:40","bln_typeable":true,"str_text":"Toggle Archive","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_button","bln_registerAtContainer":true,"str_classExtend":"xapp_console_button","blnIsTag":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":true,"bln_lockComponent":true,"str_categoryName":"Xtra","str_idProject":"myId_36985869"},"obj_domProperty":{"innerText":"Desktop","str_name":"xapp_button_navigate_desktop","innerHTML":"Toggle Archive"},"obj_domStyle":{"padding":"10px","cursor":"pointer"},"bln_enabled":true,"dom_objContentContainer":{"str_name":"xapp_button_navigate_desktop"}}],
[77335, {"obj_design":{"int_idRecord":"77335","str_idXDesign":"myId_74996919","str_name":"form_radio","str_nameShort":"form_radio","str_type":"form_radio","str_tag":"input","str_createdDate":"2022-02-02 19:57:30","str_modifiedDate":"2022-02-02 19:57:30","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_radio","bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false"},"obj_domProperty":{"checked":true,"type":"radio","Id":"myId_74996919","innerHTML":"&nbsp;"},"obj_domStyle":{"cursor":"pointer","border":"0px none","content":"\\2713","height":"40px","width":"40px","vertical-align":"middle","margin":"0px"},"dom_objContentContainer":{"Id":"myId_74996919"}}],
[77337, {"obj_design":{"int_idRecord":"77337","str_idXDesign":"myId_88201141","str_name":"form_nonbreakingspace","str_nameShort":"form_nonbreakingspace","str_type":"form_nonbreakingspace","str_themeType":"form_nonbreakingspace","str_tag":"br","bln_registerAtContainer":true,"str_createdDate":"2023-09-28 17:30:59","str_modifiedDate":"2023-09-28 17:30:59","bln_editPin":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false"},"obj_domProperty":{"Id":"myId_88201141"},"obj_domStyle":{"height":"10px","width":"100%","background":"yellow","border":"0px"},"dom_objContentContainer":{"Id":"myId_88201141"}}],
[77339, {"obj_design":{"int_idRecord":77339,"str_idXDesign":"myId_11122295","str_name":"form_label","str_nameShort":"form_label","str_type":"form_label","str_themeType":"form_label","str_tag":"label","str_createdDate":"2022-11-13 21:59:51","str_modifiedDate":"2022-11-13 21:59:51","bln_editPin":true,"bln_typeable":true,"str_text":"My Label","bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false","str_categoryName":"Xtra"},"obj_domProperty":{"innerText":"My Label","Id":"myId_11122295"},"obj_domStyle":{"padding":"10px","word-break":"normal","min-width":"175px","max-width":"175px","max-height":"175px","overflow":"auto","color":"black","align-self":"flex-start","border":"1px solid rgba(255, 255, 255, 0.0)","margin":"3px","cursor":"pointer","border-radius":"4px"},"dom_objContentContainer":{"Id":"myId_11122295"}}],
[77341, {"obj_design":{"str_tag":"span","str_type":"form_span","str_idXDesign":"myId_18418551","str_name":"form_span","str_nameShort":"form_span","str_themeType":"form_input","int_idRecord":77341,"str_createdDate":"2022-11-18 16:02:10","str_modifiedDate":"2022-11-18 16:02:10","blnIsTag":true,"bln_editPin":true,"bln_typeable":true,"bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false","str_categoryName":"Xtra"},"obj_domProperty":{"Id":"myId_18418551"},"obj_domStyle":{"padding":"10px","word-break":"normal","background":"white","maxheight":"175","overflow":"auto","color":"black","border-radius":"4px","border":"0px solid black","font-family":"Tahoma","max-height":"500px"},"user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_18418551"}}],
[77369, {"obj_design":{"str_tag":"button","str_type":"form_showhide","str_idXDesign":"myId_66358168","str_name":"form_showhide","str_nameShort":"form_showhide","str_themeType":"form_button","int_idRecord":77369,"str_createdDate":"2022-11-18 16:02:10","str_modifiedDate":"2022-11-18 16:02:10","blnIsTag":true,"bln_editPin":true,"bln_typeable":true,"bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"str_text":"Button","bln_classController":"false","bln_lockComponent":true,"str_categoryName":"Other","str_classExtend":"form_button","bln_expand":true},"obj_domProperty":{"Id":"myId_66358168","innerHTML":"Button"},"obj_domStyle":{"padding":"10px","word-break":"normal","background":"white","maxheight":"175","overflow":"auto","color":"black","border-radius":"4px","border":"0px solid black","font-family":"Tahoma","max-height":"500px"},"bln_enabled":true,"dom_objContentContainer":{"Id":"myId_66358168"}}],
[77379, {"obj_design":{"int_idRecord":77379,"str_idXDesign":"myId_48693643","str_name":"form_button_search","str_nameShort":"form_button_search","str_type":"form_button_search","str_tag":"button","str_content":"My component","str_createdDate":"2022-02-02 19:54:40","str_modifiedDate":"2022-02-02 19:54:40","bln_typeable":true,"str_text":"Search","bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_button","bln_registerAtContainer":true,"str_classExtend":"form_inputandbutton_submit","blnIsTag":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_isThemeItem":true,"bln_classController":true,"str_categoryName":"Xtra","bln_lockComponent":true},"obj_domProperty":{"type":"submit","innerText":"Submit","Id":"myId_48693643","innerHTML":"Search"},"obj_domStyle":{"padding":"10px","cursor":"pointer","border-radius":"2px","border":"0px none white","background-color":"white","flex flow":"column wrap","pointer":"black","rgb(18, 47, 66)":"rgb(18, 47, 66)"},"bln_enabled":true,"user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_48693643"}}],
[77381, {"obj_design":{"int_idRecord":77381,"str_idXDesign":"myId_92278787","str_name":"form_icon","str_nameShort":"form_icon","str_type":"form_icon","str_tag":"i","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_palettePinRelease":true,"bln_palettePin":true,"bln_createRelease":"false","bln_isLocalHome":true,"str_themeType":"form_icon","bln_editPin":true,"bln_registerAtContainer":true,"bln_classController":true,"str_categoryName":"Xtra","str_idProject":"myId_79120090"},"obj_domProperty":{"Id":"myId_92278787"},"obj_domStyle":{"margin":"10px"},"user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_92278787"}}],
[77384, {"obj_design":{"int_idRecord":77384,"str_idXDesign":"myId_97277922","str_name":"form_button","str_nameShort":"form_button","str_type":"form_button","str_themeType":"form_button","str_tag":"button","bln_registerAtContainer":true,"str_createdDate":"2022-11-20 23:26:20","str_modifiedDate":"2022-11-20 23:26:20","bln_editPin":true,"str_text":"undefined","bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":"false","str_categoryName":"Xtra"},"obj_domProperty":{"innerText":"My Button","innerHTML":"undefined","type":"submit"},"obj_domStyle":{"cursor":"pointer","border":"0px none","height":"40px","padding":"10px","border-radius":"2px"},"bln_enabled":true}],
...
[77396, {"obj_design":{"int_idRecord":77396,"str_idXDesign":"myId_25205280","str_name":"xapp_button_navigate_settings","str_nameShort":"xapp_button_navigate_settings","str_type":"xapp_button_navigate_settings","str_tag":"button","str_content":"My component","str_createdDate":"2022-02-02 19:54:40","str_modifiedDate":"2022-02-02 19:54:40","bln_typeable":true,"bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_button","bln_registerAtContainer":true,"str_classExtend":"xapp_console_button","blnIsTag":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":true,"bln_lockComponent":true,"str_categoryName":"Other","arr_item":[{"obj_design":{"int_idRecord":77393,"str_type":"form_button_anchor"}}],"str_idProject":"myId_25365115","str_nameRegistrator":"notset","str_classList":"notset","str_releaseLabel":"notset","str_text":"Settings","str_lastVersionDate":"notset","str_icon":"fa-solid fa-gear"},"obj_domProperty":{"innerText":"Complete","innerHTML":"Refresh","aria-label":"Settings","Id":"myId_25205280"},"obj_domStyle":{"padding":"10px","cursor":"pointer","opacity":"1"},"bln_enabled":true,"user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_25205280","aria-label":"Settings"}}],
[77397, {"obj_design":{"int_idRecord":77397,"str_idXDesign":"myId_15925355","str_name":"xapp_button_navigate_desktop","str_nameShort":"xapp_button_navigate_desktop","str_type":"xapp_button_navigate_desktop","str_tag":"button","str_content":"My component","str_createdDate":"2022-02-02 19:54:40","str_modifiedDate":"2022-02-02 19:54:40","bln_typeable":true,"bln_createRelease":"false","bln_isLocalHome":true,"bln_editPin":true,"str_themeType":"form_button","bln_registerAtContainer":true,"str_classExtend":"xapp_console_button","blnIsTag":true,"bln_palettePinRelease":true,"bln_palettePin":true,"bln_classController":true,"bln_lockComponent":true,"str_categoryName":"Other","arr_item":[{"obj_design":{"int_idRecord":77393,"str_type":"form_button_anchor"}}],"str_idProject":"myId_25365115","str_nameRegistrator":"notset","str_classList":"notset","str_releaseLabel":"notset","str_text":"Home","str_lastVersionDate":"notset","str_icon":"fa-solid fa-home"},"obj_domProperty":{"innerText":"Complete","innerHTML":"Refresh","aria-label":"Home","Id":"myId_15925355"},"obj_domStyle":{"padding":"10px","cursor":"pointer","opacity":"1"},"bln_enabled":true,"user_agent":"Firefox","dom_objContentContainer":{"Id":"myId_15925355","aria-label":"Home"}}],
...
[77414, {"obj_design":{"str_tag":"span","str_type":"form_menu_button_span","str_idXDesign":"myId_31070796","str_name":"form_menu_button_span","str_nameShort":"form_menu_button_span","str_themeType":"form_menu_button_span","int_idRecord":"77414","str_createdDate":"2022-11-18 16:02:10","str_modifiedDate":"2022-11-18 16:02:10","blnIsTag":true,"bln_editPin":true,"bln_typeable":true,"bln_registerAtContainer":true,"bln_palettePinRelease":true,"bln_palettePin":true,"str_idProject":"myId_11190110","str_text":"My Menubutton","bln_isThemeItem":true,"bln_classController":"false"},"obj_domProperty":{"Id":"myId_31070796","innerHTML":"My Menubutton"},"obj_domStyle":{"maxheight":"175","display":"block","color":"white"},"dom_objContentContainer":{"Id":"myId_31070796","value":"My Menubutton"}}],
[77415, {"obj_design":{"int_idRecord":"77415","str_idXDesign":"myId_37917993","str_name":"form_menu_button_icon","str_nameShort":"form_menu_button_icon","str_type":"form_menu_button_icon","str_tag":"i","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_palettePinRelease":true,"bln_palettePin":true,"bln_createRelease":"false","bln_isLocalHome":true,"str_themeType":"form_menu_button_icon","bln_editPin":true,"bln_registerAtContainer":true,"str_idProject":"myId_79120090","bln_isThemeItem":true,"bln_classController":"false"},"obj_domProperty":{"Id":"myId_37917993"},"obj_domStyle":{"display":"none","color":"white"},"dom_objContentContainer":{"Id":"myId_37917993"}}],
[77416, {"obj_design":{"int_idRecord":"77416","str_idXDesign":"myId_61317270","str_name":"form_menu_button_anchor","str_nameShort":"form_menu_button_anchor","str_type":"form_menu_button_anchor","str_tag":"a","str_createdDate":"2022-01-31 21:05:11","str_modifiedDate":"2022-01-31 21:05:11","bln_palettePinRelease":true,"bln_palettePin":true,"bln_createRelease":"false","bln_isLocalHome":true,"str_themeType":"form_menu_button_anchor","bln_editPin":true,"bln_registerAtContainer":true,"arr_item":[{"obj_design":{"int_idRecord":"77414","str_type":"form_menu_button_span"}},{"obj_design":{"int_idRecord":"77415","str_type":"form_menu_button_icon"}}],"str_idProject":"myId_08882881","bln_isThemeItem":true,"bln_classController":"false"},"obj_domProperty":{"target":"_blank","Id":"myId_61317270"},"obj_domStyle":{"display":"flex","justify-content":"center","align-items":"center","gap":"10px","text":"de","text-decoration":"none","border":"0px solid black"},"dom_objContentContainer":{"Id":"myId_61317270"},"obj_icon":{"obj_design":{"int_idRecord":"77415","str_type":"form_menu_button_icon"}},"obj_span":{"obj_design":{"int_idRecord":"77414","str_type":"form_menu_button_span"}}}],
