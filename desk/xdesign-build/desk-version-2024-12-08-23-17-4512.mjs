...
[6051, {"obj_color": {"red": "hsl(0, 100%, 50%)", "tan": "hsl(34, 44%, 69%)", "aqua": "hsl(180, 100%, 50%)", "blue": "hsl(240, 100%, 50%)", "cyan": "hsl(180, 100%, 50%)", "gold": "hsl(51, 100%, 50%)", "gray": "hsl(0, 0%, 50%)", "lime": "hsl(120, 100%, 50%)", "navy": "hsl(240, 100%, 25%)", "peru": "hsl(30, 59%, 53%)", "pink": "hsl(350, 100%, 88%)", "plum": "hsl(300, 47%, 75%)", "snow": "hsl(0, 100%, 99%)", "teal": "hsl(180, 100%, 25%)", "azure": "hsl(180, 100%, 97%)", "beige": "hsl(60, 56%, 91%)", "black": "hsl(0, 0%, 0%)", "brown": "hsl(0, 59%, 41%)", "coral": "hsl(16, 100%, 66%)", "green": "hsl(120, 100%, 25%)", "ivory": "hsl(60, 100%, 97%)", "khaki": "hsl(54, 77%, 75%)", "linen": "hsl(30, 67%, 94%)", "olive": "hsl(60, 100%, 25%)", "wheat": "hsl(39, 77%, 83%)", "white": "hsl(0, 0%, 100%)", "bisque": "hsl(33, 100%, 88%)", "indigo": "hsl(275, 100%, 25%)", "maroon": "hsl(0, 100%, 25%)", "orange": "hsl(39, 100%, 50%)", "orchid": "hsl(302, 59%, 65%)", "purple": "hsl(300, 100%, 25%)", "salmon": "hsl(6, 93%, 71%)", "sienna": "hsl(19, 56%, 40%)", "silver": "hsl(0, 0%, 75%)", "tomato": "hsl(9, 100%, 64%)", "violet": "hsl(300, 76%, 72%)", "yellow": "hsl(60, 100%, 50%)", "crimson": "hsl(348, 83%, 47%)", "fuchsia": "hsl(300, 100%, 50%)", "magenta": "hsl(300, 100%, 50%)", "thistle": "hsl(300, 24%, 80%)", "cornsilk": "hsl(48, 100%, 93%)", "dark_red": "hsl(0, 100%, 27%)", "dim_gray": "hsl(0, 0%, 41%)", "honeydew": "hsl(120, 100%, 97%)", "hot_pink": "hsl(330, 100%, 71%)", "lavender": "hsl(240, 67%, 94%)", "moccasin": "hsl(38, 100%, 85%)", "old_lace": "hsl(39, 85%, 95%)", "seashell": "hsl(25, 100%, 97%)", "sky_blue": "hsl(197, 71%, 73%)", "chocolate": "hsl(25, 75%, 47%)", "dark_blue": "hsl(240, 100%, 27%)", "dark_cyan": "hsl(180, 100%, 27%)", "dark_gray": "hsl(0, 0%, 66%)", "deep_pink": "hsl(328, 100%, 54%)", "firebrick": "hsl(0, 68%, 42%)", "gainsboro": "hsl(0, 0%, 86%)", "goldenrod": "hsl(43, 74%, 49%)", "sea_green": "hsl(146, 50%, 36%)", "turquoise": "hsl(174, 72%, 56%)", "alice_blue": "hsl(208, 100%, 97%)", "aquamarine": "hsl(160, 100%, 75%)", "burly_wood": "hsl(34, 57%, 70%)", "cadet_blue": "hsl(182, 25%, 50%)", "chartreuse": "hsl(90, 100%, 50%)", "dark_green": "hsl(120, 100%, 20%)", "dark_khaki": "hsl(56, 38%, 58%)", "indian_red": "hsl(0, 53%, 58%)", "lawn_green": "hsl(90, 100%, 50%)", "light_blue": "hsl(195, 53%, 79%)", "light_cyan": "hsl(180, 100%, 94%)", "light_gray": "hsl(0, 0%, 83%)", "light_pink": "hsl(351, 100%, 86%)", "lime_green": "hsl(120, 61%, 50%)", "mint_cream": "hsl(150, 100%, 98%)", "misty_rose": "hsl(6, 100%, 94%)", "olive_drab": "hsl(80, 60%, 35%)", "orange_red": "hsl(16, 100%, 50%)", "pale_green": "hsl(120, 93%, 79%)", "peach_puff": "hsl(28, 100%, 86%)", "rosy_brown": "hsl(0, 25%, 65%)", "royal_blue": "hsl(225, 73%, 57%)", "slate_blue": "hsl(248, 53%, 58%)", "slate_gray": "hsl(210, 13%, 50%)", "steel_blue": "hsl(207, 44%, 49%)", "blue_violet": "hsl(271, 76%, 53%)", "dark_orange": "hsl(33, 100%, 50%)", "dark_orchid": "hsl(280, 61%, 50%)", "dark_salmon": "hsl(15, 72%, 70%)", "dark_violet": "hsl(282, 100%, 41%)", "dodger_blue": "hsl(210, 100%, 56%)", "ghost_white": "hsl(240, 100%, 99%)", "light_coral": "hsl(0, 79%, 72%)", "light_green": "hsl(120, 73%, 75%)", "medium_blue": "hsl(240, 100%, 40%)", "papaya_whip": "hsl(37, 100%, 92%)", "powder_blue": "hsl(187, 52%, 80%)", "sandy_brown": "hsl(28, 87%, 67%)", "white_smoke": "hsl(0, 0%, 96%)", "dark_magenta": "hsl(300, 100%, 27%)", "floral_white": "hsl(40, 100%, 97%)", "forest_green": "hsl(120, 61%, 34%)", "green_yellow": "hsl(84, 100%, 59%)", "light_salmon": "hsl(17, 100%, 74%)", "light_yellow": "hsl(60, 100%, 94%)", "navajo_white": "hsl(36, 100%, 84%)", "saddle_brown": "hsl(25, 76%, 31%)", "spring_green": "hsl(150, 100%, 50%)", "yellow_green": "hsl(80, 61%, 50%)", "antique_white": "hsl(34, 78%, 91%)", "deep_sky_blue": "hsl(195, 100%, 50%)", "lemon_chiffon": "hsl(54, 100%, 90%)", "medium_orchid": "hsl(288, 59%, 58%)", "medium_purple": "hsl(260, 60%, 65%)", "midnight_blue": "hsl(240, 64%, 27%)", "dark_goldenrod": "hsl(43, 89%, 38%)", "dark_sea_green": "hsl(120, 25%, 65%)", "dark_turquoise": "hsl(181, 100%, 41%)", "lavender_blush": "hsl(340, 100%, 97%)", "light_sky_blue": "hsl(203, 92%, 75%)", "pale_goldenrod": "hsl(55, 67%, 80%)", "pale_turquoise": "hsl(180, 65%, 81%)", "rebecca_purple": "hsl(270, 50%, 40%)", "blanched_almond": "hsl(36, 100%, 90%)", "cornflower_blue": "hsl(219, 79%, 66%)", "dark_slate_blue": "hsl(248, 39%, 39%)", "dark_slate_gray": "hsl(180, 25%, 25%)", "light_sea_green": "hsl(177, 70%, 41%)", "pale_violet_red": "hsl(340, 60%, 65%)", "dark_olive_green": "hsl(82, 39%, 30%)", "light_slate_gray": "hsl(210, 14%, 53%)", "light_steel_blue": "hsl(214, 41%, 78%)", "medium_sea_green": "hsl(147, 50%, 47%)", "medium_turquoise": "hsl(178, 60%, 55%)", "medium_aquamarine": "hsl(160, 51%, 60%)", "medium_slate_blue": "hsl(249, 80%, 67%)", "medium_violet_red": "hsl(322, 81%, 43%)", "medium_spring_green": "hsl(157, 100%, 49%)", "light_goldenrod_yellow": "hsl(60, 80%, 90%)"}, "obj_theme": {"obj_design": {"str_type": "xapp_theme", "int_idRecord": 77570}}, "obj_design": {"str_tag": "desk", "arr_item": [{"obj_design": {"str_type": "xapp_theme", "int_idRecord": 77570}}, {"obj_design": {"str_type": "xapp_dynamic_content", "int_idRecord": 117}}, {"obj_design": {"str_type": "xapp_context_holder", "int_idRecord": 76385}}, {"obj_design": {"str_type": "authorise_gate", "int_idRecord": 6009}}], "str_name": "desk", "str_text": "notset", "str_type": "desk", "bln_editPin": true, "str_content": "", "int_idRecord": 6051, "str_classList": "notset", "str_iconStyle": "default", "str_idProject": "notset", "str_idXDesign": "myId_24662136", "str_nameShort": "desk", "str_themeType": "desk", "int_idMetaMenu": "186", "bln_isLocalHome": true, "str_classExtend": "xapp", "str_createdDate": "2022-09-18 17:59:11", "str_categoryName": "Desk", "str_modifiedDate": "2022-09-18 17:59:11", "str_releaseLabel": "notset", "bln_lockComponent": true, "bln_classController": true, "str_lastVersionDate": "notset", "str_nameRegistrator": "notset", "int_radioDisplayMode": 3}, "user_agent": "Firefox", "bln_isMobile": true, "MetaDataViewId": 101426, "MetaLinkViewId": 100475, "MetaUserViewId": 1, "obj_domProperty": {"Id": "myId_24662136"}, "MetaDataViewName": "meta_data", "MetaLinkViewName": "meta_link", "MetaUserViewName": "meta_user", "bln_closePeersPin": true, "bln_togglePeersPin": true, "dom_objContentContainer": {"Id": "myId_24662136"}}],
